...
@section('content')
    <h1 class="text-2x1 font-semibold leading-tigh py-2">Comentários do Usuário - {{$user->name}} | <a href="{{ route('comments.create', ['id' => $user->id]) }}" class="bg-blue-900 rounded-full text-white px-4 text-sm">+</a></h1>
